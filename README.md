...
# Installation steps:
1. Download the latest release from the following link: https://github.com/rileymd88/automation-trigger/releases/download/v1.1.7/automation-trigger.zip
...
* 1.1.6
  * Updated to deal with new automations API
* 1.1.5
  * Bug fixes
* 1.1.4
...
* 1.1.3
  * Bug fixes
* 1.1.2
  * Further bug fixes for error when user runs an automation that they do not own
* 1.1.1
  * Fixed error when user runs an automation that they do not own
* 1.1.0
